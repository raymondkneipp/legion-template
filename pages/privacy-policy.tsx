      ...
      <section className="container mx-auto px-2 my-36 grid grid-cols-3 gap-12">
        ...
        <div className="col-span-2 grid grid-cols-1 gap-6">
          ...
          <ul className="text-gray-500">
            <li>
              <p className="text-gray-500">
                <strong className="text-sky-700">Account</strong> means a unique
            ...
            <li>
              <p className="text-gray-500">
                <strong className="text-sky-700">Cookies</strong> are small
            ...
            <li>
              <p className="text-gray-500">
                <strong className="text-sky-700">Personal Data</strong> is any
            ...
            <li>
              <p className="text-gray-500">
                <strong className="text-sky-700">Service Provider</strong> means
            ...
            <li>
              <p className="text-gray-500">
                <strong className="text-sky-700">Usage Data</strong> refers to
          ...
          <ul className="text-gray-500">
            ...
            <li>
              <p className="text-gray-500">First name and last name</p>
            </li>
            <li>
            ...
            <li>
              <p className="text-gray-500">Usage Data</p>
            </li>
          </ul>
          ...
          <ul className="text-gray-500">
            ...
            <li>
              <strong className="text-sky-700">Flash Cookies.</strong> Certain
              ...
              the same browser settings as those used for Browser Cookies. For
              more information on how You can delete Flash Cookies, please read
            ...
            <li>
              <strong className="text-sky-700">Web Beacons.</strong> Certain
          ...
          <ul className="text-gray-500">
            <li>
              ...
              <p className="text-gray-500">Type: Session Cookies</p>
              <p className="text-gray-500">Administered by: Us</p>
              <p className="text-gray-500">
            ...
            <li>
              ...
              <p className="text-gray-500">Type: Persistent Cookies</p>
              <p className="text-gray-500">Administered by: Us</p>
              <p className="text-gray-500">
            ...
            <li>
              <p className="text-gray-500">
                <strong className="text-sky-700">Functionality Cookies</strong>
              </p>
              <p className="text-gray-500">Type: Persistent Cookies</p>
              <p className="text-gray-500">Administered by: Us</p>
              <p className="text-gray-500">
          ...
          <ul className="text-gray-500">
            ...
            <li>
              <p className="text-gray-500">
                <strong className="text-sky-700">To contact You:</strong> To
            ...
            <li>
              <p className="text-gray-500">
                <strong className="text-sky-700">To provide You</strong> with
            ...
            <li>
              <p className="text-gray-500">
                <strong className="text-sky-700">For other purposes</strong>: We
          ...
          <ul className="text-gray-500">
            <li>
              <strong className="text-sky-700">With Service Providers:</strong>{' '}
              We may share Your personal information with Service Providers to
              monitor and analyze the use of our Service, to contact You.
            </li>
            <li>
              <strong className="text-sky-700">For business transfers:</strong>{' '}
            ...
            <li>
              <strong className="text-sky-700">With Affiliates:</strong> We may
            ...
            <li>
              <strong className="text-sky-700">With business partners:</strong>{' '}
              We may share Your information with Our business partners to offer
              You certain products, services or promotions.
            </li>
            <li>
              <strong className="text-sky-700">With other users:</strong> when
            ...
            <li>
              <strong className="text-sky-700">With Your consent</strong>: We
          ...
          <h2 className="text-sky-700 font-bold text-xl">Children's Privacy</h2>
          <p className="text-gray-500">
