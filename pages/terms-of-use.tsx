      ...
      <section className="container mx-auto px-2 my-36 grid grid-cols-3 gap-12">
        <div className="space-y-6">
          <div className="space-y-2">
            <h1 className="font-bold text-5xl">Terms of Use</h1>
            <h6 className="text-sky-700 text-lg">
        ...
        <div className="col-span-2 grid grid-cols-1 gap-6">
          <h2 className="text-sky-700 font-bold text-xl">
          ...
          <ul className="text-gray-700">
            <li>
              <p className="text-gray-500">
                <strong className="text-sky-700">Affiliate</strong> means an
            ...
            <li>
              <p className="text-gray-500">
                <strong className="text-sky-700">Country</strong> refers to:
                California, United States
              </p>
            </li>
            <li>
              <p className="text-gray-500">
                <strong className="text-sky-700">Company</strong> (referred to
                as either &quot;the Company&quot;, &quot;We&quot;,
                &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to
                Example LLC, 1234 Main St. CA 95014.
              </p>
            </li>
            <li>
              <p className="text-gray-500">
                <strong className="text-sky-700">Device</strong> means any
            ...
            <li>
              <p className="text-gray-500">
                <strong className="text-sky-700">Service</strong> refers to the
                Website.
              </p>
            </li>
            <li>
              <p className="text-gray-500">
                <strong className="text-sky-700">Terms and Conditions</strong>{' '}
            ...
            <li>
              <p className="text-gray-500">
                <strong className="text-sky-700">Website</strong> refers to
                Example Site, accessible from{' '}
                <a
            ...
            <li>
              <p className="text-gray-500">
                <strong className="text-sky-700">You</strong> means the
          ...
          <h2 className="text-sky-700 font-bold text-xl">Acknowledgment</h2>
          <p className="text-gray-500">
          ...
          <h2 className="text-sky-700 font-bold text-xl">Termination</h2>
          <p className="text-gray-500">
          ...
          <h2 className="text-sky-700 font-bold text-xl">Governing Law</h2>
          <p className="text-gray-500">
          ...
          <h3 className="text-lg font-bold">Severability</h3>
          <p className="text-gray-500">
          ...
          <h3 className="text-lg font-bold">Waiver</h3>
          <p className="text-gray-500">
          ...
          <h2 className="text-sky-700 font-bold text-xl">Contact Us</h2>
          <p className="text-gray-500">
